...
def parse_opt(known=False):
    ...
    parser.add_argument("--dln_weights", type=str, default= "D:/syx_projects/DLN_yolov5L/DLN_master/models/DLN_500.pth", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="", help="model.yaml path")
    parser.add_argument("--data", type=str, default= "D:/syx_projects/DLN_yolov5L/ExDark/exdark.yaml", help="dataset.yaml path")
